...
trans = {
    ...
    Student: 'Estudia actualment',
    EducationTypes: 'Tipus de formació',
    SelfTaughtTypes: "Tipus d'auto-formació",
    YearsCoding: 'Anys escrivint codi',
    YearsCodingProf: 'Anys escrivint codi com a professional',
    Gender: 'Sexe',
    RaceEthnicity: 'Raça / Ètnia',
    EducationParents: 'Educació dels pares',
    Age: 'Edat',
    Dependents: 'Persones a càrrec',
    JobSatisfaction: 'Satisfacció laboral',
    CareerSatisfaction: 'Satisfacció professional',
    HopeFiveYears: 'Projecció a 5 anys',
    JobSearchStatus: 'Cercant feina?',
    LastNewJob: 'Temps en la feina actual',
    OperatingSystem: 'Sistemes Operatius',
    NumberMonitors: 'Nº de monitors',
    Methodology: 'Metodologies',
    VersionControl: 'Control de versions',
    CommunicationTools: 'Eines de comunicació',
    WakeTime: 'Hora en què es lleva',
    HoursComputer: 'Hores davant ordinador',
    HoursOutside: 'Hores en exteriors',
    SkipMeals: 'Es salta dinars',
    ErgonomicDevices: 'Ergonomia',
